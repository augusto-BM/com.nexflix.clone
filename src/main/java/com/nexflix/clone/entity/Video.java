package com.nexflix.clone.entity;
...
public class Video {
    ...
    public String getSrc() {
        if(this.srcUuid != null && !srcUuid.isEmpty()){
            String baseUrl = ServletUriComponentsBuilder.fromCurrentRequest().build().toUriString();
            return baseUrl + "/api/files/video" + this.srcUuid;
        }
        return null;
    }
    ...
    public String getPoster() {
        if(this.posterUuid != null && !posterUuid.isEmpty()){
            String baseUrl = ServletUriComponentsBuilder.fromCurrentRequest().build().toUriString();
            return baseUrl+ "/api/files/poster" + this.posterUuid;
        }
        return null;
    }
}
